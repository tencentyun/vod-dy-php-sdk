 ...
 * 视频转动图结果信息
 *
 * @method TaskOutputStorageForDY getStorage() 获取转动图文件的存储位置。
 * @method void setStorage(TaskOutputStorageForDY $Storage) 设置转动图文件的存储位置。
 ...
 */
class MediaAnimatedGraphicsItemForDY extends AbstractModel
{
    /**
     * @var TaskOutputStorageForDY 转动图文件的存储位置。
     */
    public $Storage;
    ...
    /**
     * @param TaskOutputStorageForDY $Storage 转动图文件的存储位置。
