 ...
 * 编辑点播视频文件信息
 *
 * @method MediaInputInfoForDY getInputInfo() 获取视频的输入信息。
 * @method void setInputInfo(MediaInputInfoForDY $InputInfo) 设置视频的输入信息。
 ...
 */
class EditMediaFileInfoForDY extends AbstractModel
{
    /**
     * @var MediaInputInfoForDY 视频的输入信息。
     */
    public $InputInfo;
    ...
    /**
     * @param MediaInputInfoForDY $InputInfo 视频的输入信息。
