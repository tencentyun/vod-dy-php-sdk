 ...
 * @method TaskOutputStorageForDY getStorage() 获取雪碧图文件的存储位置。
 * @method void setStorage(TaskOutputStorageForDY $Storage) 设置雪碧图文件的存储位置。
 */
class MediaImageSpriteItemForDY extends AbstractModel
{
    /**
    ...
    /**
     * @var TaskOutputStorageForDY 雪碧图文件的存储位置。
     */
    public $Storage;
     ...
     * @param TaskOutputStorageForDY $Storage 雪碧图文件的存储位置。
     */
