...
<li>当 SampleType 为 Percent 时，该值表示多少百分比一张图。</li>
<li>当 SampleType 为 Time 时，该值表示多少时间间隔一张图，单位秒， 第一张图均为视频首帧。</li>
 * @method TaskOutputStorageForDY getStorage() 获取截图后文件的存储位置。
 * @method void setStorage(TaskOutputStorageForDY $Storage) 设置截图后文件的存储位置。
 ...
 */
class MediaSampleSnapshotItemForDY extends AbstractModel
{
    /**
...
<li>当 SampleType 为 Time 时，该值表示多少时间间隔一张图，单位秒， 第一张图均为视频首帧。</li>
    ...
    /**
     * @var TaskOutputStorageForDY 截图后文件的存储位置。
     */
    public $Storage;
...
<li>当 SampleType 为 Percent 时，该值表示多少百分比一张图。</li>
<li>当 SampleType 为 Time 时，该值表示多少时间间隔一张图，单位秒， 第一张图均为视频首帧。</li>
     * @param TaskOutputStorageForDY $Storage 截图后文件的存储位置。
