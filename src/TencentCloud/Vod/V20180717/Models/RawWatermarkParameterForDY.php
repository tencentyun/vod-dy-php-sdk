...
<li>当字符串以 px 结尾，表示水印 YPos 为指定像素，如 100px 表示 YPos 为 100 像素。</li>
默认值：0px。
 * @method RawImageWatermarkInputForDY getImageTemplate() 获取图片水印模板，当 Type 为 image，该字段必填。当 Type 为 text，该字段无效。
 * @method void setImageTemplate(RawImageWatermarkInputForDY $ImageTemplate) 设置图片水印模板，当 Type 为 image，该字段必填。当 Type 为 text，该字段无效。
 */
class RawWatermarkParameterForDY extends AbstractModel
{
    /**
     * @var string 水印类型，可选值：
<li>image：图片水印。</li>
...
默认值：0px。
    ...
    /**
     * @var RawImageWatermarkInputForDY 图片水印模板，当 Type 为 image，该字段必填。当 Type 为 text，该字段无效。
     */
...
<li>当字符串以 px 结尾，表示水印 YPos 为指定像素，如 100px 表示 YPos 为 100 像素。</li>
默认值：0px。
     * @param RawImageWatermarkInputForDY $ImageTemplate 图片水印模板，当 Type 为 image，该字段必填。当 Type 为 text，该字段无效。
     */
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("ImageTemplate",$param) and $param["ImageTemplate"] !== null) {
            $this->ImageTemplate = new RawImageWatermarkInputForDY();
