 ...
 * @method TaskOutputStorageForDY getStorage() 获取自适应码流文件的存储位置。
 * @method void setStorage(TaskOutputStorageForDY $Storage) 设置自适应码流文件的存储位置。
 */
class AdaptiveDynamicStreamingInfoItemForDY extends AbstractModel
{
    /**
    ...
    /**
     * @var TaskOutputStorageForDY 自适应码流文件的存储位置。
     */
    public $Storage;
     ...
     * @param TaskOutputStorageForDY $Storage 自适应码流文件的存储位置。
     */
