 ...
 * 转码信息
 *
 * @method TaskOutputStorageForDY getOutputStorage() 获取转码后文件的目标存储。
 * @method void setOutputStorage(TaskOutputStorageForDY $OutputStorage) 设置转码后文件的目标存储。
 ...
 */
class MediaTranscodeItemForDY extends AbstractModel
{
    /**
     * @var TaskOutputStorageForDY 转码后文件的目标存储。
     */
    ...
    /**
     * @param TaskOutputStorageForDY $OutputStorage 转码后文件的目标存储。
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("AudioStreamSet",$param) and $param["AudioStreamSet"] !== null) {
            ...
            foreach ($param["AudioStreamSet"] as $key => $value){
                $obj = new MediaAudioStreamItemForDY();
        ...
        if (array_key_exists("VideoStreamSet",$param) and $param["VideoStreamSet"] !== null) {
            ...
            foreach ($param["VideoStreamSet"] as $key => $value){
                $obj = new MediaVideoStreamItemForDY();
                $obj->deserialize($value);
